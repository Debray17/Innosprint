...
import { Box, Typography, Paper, FormControl, InputLabel, Select, MenuItem, TextField, Button, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Chip, LinearProgress, Avatar } from "@mui/material";
...
import { properties, rooms, bookings } from "../../data/mockData";
...
const OccupancyReportPage = () => {
  ...
  return (
    <Box>
          ...
          <Grid size={{ xs: 12, sm: 6, md: 4 }} key={roomType.type}>
                            <Paper
              sx={{
                p: 2,
